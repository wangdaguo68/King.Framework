namespace King.Framework.LiteQueryDef.CSharpTypes
{
    ...
    internal static class SharpTypeHelper
    {
        ...
        static SharpTypeHelper()
        {
            ...
            oracleTypehelpers.Add(typeof(string), new StringType_Oracle());
            oracleTypehelpers.Add(typeof(int), new IntType_Oracle());
            oracleTypehelpers.Add(typeof(int?), new IntNullableType_Oracle());
            oracleTypehelpers.Add(typeof(long), new LongType_Oracle());
            oracleTypehelpers.Add(typeof(long?), new LongNullableType_Oracle());
            oracleTypehelpers.Add(typeof(decimal), new DecimalType_Oracle());
            oracleTypehelpers.Add(typeof(decimal?), new DecimalNullableType_Oracle());
            oracleTypehelpers.Add(typeof(DateTime), new DateTimeType_Oracle());
            oracleTypehelpers.Add(typeof(DateTime?), new DateTimeNullableType_Oracle());
            oracleTypehelpers.Add(typeof(bool), new BoolType_Oracle());
            oracleTypehelpers.Add(typeof(bool?), new BoolNullableType_Oracle());
            oracleTypehelpers.Add(typeof(Guid), new GuidType_Oracle());
            oracleTypehelpers.Add(typeof(Guid?), new GuidNullableType_Oracle());
            oracleTypehelpers.Add(typeof(byte[]), new ByteArrayType_Oracle());
            oracleTypehelpers.Add(typeof(byte), new ByteType_Oracle());
            oracleTypehelpers.Add(typeof(byte?), new ByteNullableType_Oracle());
            oracleTypehelpers.Add(typeof(short), new ShortType_Oracle());
            oracleTypehelpers.Add(typeof(short?), new ShortNullableType_Oracle());
            oracleTypehelpers.Add(typeof(double), new DoubleType_Oracle());
            oracleTypehelpers.Add(typeof(double?), new DoubleNullableType_Oracle());
        }
